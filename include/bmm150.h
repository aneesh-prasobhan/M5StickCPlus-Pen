...
class BMM150 {
   public:
    ...
    /**
     * @brief This internal API reads the trim registers of the sensor and
     * stores the trim values in the "trim_data" of device structure.
     */
    ...
    int8_t validate_adv_self_test(int16_t positive_data_z, int16_t
    negative_data_z); void set_adv_self_test_current(uint8_t self_test_current);
    void set_control_measurement_xyz(struct bmm150_settings settings);
  */

    /**
     * @brief This internal API sets the preset mode ODR and repetition
     * settings.
     */
    ...
    /**
     * @brief This internal API sets the z repetition value in the 0x52
     * register.
     */
